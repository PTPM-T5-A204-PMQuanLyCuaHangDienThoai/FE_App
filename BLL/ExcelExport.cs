...
namespace DemoBuoi7
{
    public class ExcelExport
    {
        ...
        public const string T_PhieuXuat = "phieuxuat";
        #endregion
        ...
        public bool ExportData(List<CTPXExcel> dataSource, string fileName, bool isPrintPreview, String TongTien, String NhanVien, String KhachHang, String date, String TrangThai)
        {
            // Check if data is null
          ...
          //  string tongSo = dataSource.Sum(t => t.SoLuong).Value.ToString();
            ...
            replacer.Add("%TongTien", TongTien);
            replacer.Add("%NhanVien", NhanVien);
            replacer.Add("%KhachHang", KhachHang);
            replacer.Add("%Ngay", date);
            replacer.Add("%TrangThai", TrangThai);

            BuildReplacerCurrentDate(ref replacer);

            return OutSimpleReport(dataSource, replacer, "phieuxuat", isPrintPreview, ref fileName);
        }
